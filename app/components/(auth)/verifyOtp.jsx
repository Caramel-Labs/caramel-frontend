...
export default function VerifyOTP() {
 ...
 // keep the cursor always in the end of the input value
  ...
  return (
    <div className="relative flex min-h-screen flex-col justify-center overflow-hidden  py-12 bg-zinc-950">
      <div className="relative  px-6 pt-10 pb-9 shadow-xl mx-auto w-full max-w-lg rounded-2xl bg-zinc-950">
