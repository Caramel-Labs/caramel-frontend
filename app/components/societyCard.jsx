...
export default function SocietyCard(props) {
    ...
    return (
        <div key={i}>
            ...
            <div className="relative flex w-full max-w-[48rem] flex bg-white bg-clip-border text-gray-700 shadow-md mt-9">
                <div className="relative m-0 w-2/5 shrink-0 overflow-hidden   bg-white bg-clip-border text-gray-700 flex items-center">
                    <img
                        src={imgPath}
                        alt="image"
                ...
                <div className="p-6">
                    <h4 className="mb-2 font-sans text-2xl font-semibold leading-snug tracking-normal text-blue-gray-900 antialiased text-base font-bold">
                        {societyName}
                    </h4>
                    <p className="mb-8 font-sans text-gray-700 antialiased text-xs line-clamp-1">
                        {description}
                    </p>
                    ...
                    <div class="flex -space-x-4">
                        ...
                        <div class="w-3/4 p-4 ml-2 text-xs">
