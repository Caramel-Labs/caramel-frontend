            ...
            <div className="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm p-4 sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
                ...
                <form className="space-y-6" action="#">
                    ...
                    <div className="flex items-start">
                        <Link href="#" className="text-sm text-blue-700 hover:underline ml-auto dark:text-blue-500">forgot Password? </Link>
                    </div>
                    ...
                    <div className="text-sm font-medium text-gray-500 dark:text-gray-300"> Not registered? 
                         <Link href="#" class="text-blue-700 hover:underline dark:text-blue-500">Create account</Link>
                    </div>
