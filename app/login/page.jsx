                ...
                <div className="bg-white rounded-lg h-1/2 max-w-sm p-4 sm:p-6 lg:p-8">
                    ...
                    <form className="space-y-6" action="#">
                        ...
                        <div>
                            ...
                            <input type="password" name="password" id="password" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5" required=""/>
                        </div>
                        ...
                        <div className="text-sm font-medium text-gray-500">Not registered?&nbsp;
                            <Link href="#" class="text-orange-700 hover:underline dark:text-orange-500">Create account</Link>
                        </div>
